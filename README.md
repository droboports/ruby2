...
Check the [releases](https://github.com/droboports/ruby2/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/ruby2.git
cd ruby2
./build.sh
ls -la *.tgz
```
